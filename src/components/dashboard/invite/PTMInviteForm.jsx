        ...
        <div className="space-y-4">
            ...
            <div className="flex gap-3">
                ...
                <input
                    ...
                    value={formData.day}
                    readOnly
                    className={`w-[157px] h-[41px] px-[20px] py-[10px] border border-gray-200 rounded-[14px] focus:outline-none text-sm transition-all duration-200 placeholder:font-poppins placeholder:font-medium placeholder:text-[14px] placeholder:leading-[100%] placeholder:tracking-[0%]`}
                />
